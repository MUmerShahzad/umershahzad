...
import 'package:umershahzad/utils/image_asset_constants.dart';
import 'package:umershahzad/widgets/logo.dart';
import 'package:umershahzad/widgets/nav_bar_button.dart';
import 'package:umershahzad/widgets/nav_bar_item.dart';
import 'package:umershahzad/widgets/nav_bar_item_with_icon.dart';
  ...
  Widget build(BuildContext context) {
      ...
      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
        ...
        Row(children: const [
          NavBarItemWithIcon(
            ...
            url: 'https://github.com/MUmerShahzad',
          ),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'facebook',
    ...
    List<Widget>? navBarColumn = [
      ...
      NavBarItem(
          text: 'github',
          onTap: () async {
            await launch('https://github.com/MUmerShahzad');
          }),
      NavBarItem(
          text: 'facebook',
          onTap: () async =>
